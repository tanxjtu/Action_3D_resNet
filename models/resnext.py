...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, sample_size, sample_duration,
                 shortcut_type='B', cardinality=32, num_classes=400, **kwargs):
        self.inplanes = 64
        ...
        self.layer4 = self._make_layer(block, 1024, layers[3], shortcut_type, cardinality, stride=1)
        # self.Conv_Down = nn.Conv3d(2048, 512, (1, 1, 1), 1, bias=True)
